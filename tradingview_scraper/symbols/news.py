...
class NewsScraper:
    ...
    def _load_languages(self):
        ...
        """
        path = os.path.join(os.path.dirname(__file__), '..', 'data', 'languages.json')
    ...
    def _load_news_providers(self):
        ...
        Raises:
            IOError: If there is an error reading the file.
        """
        path = os.path.join(os.path.dirname(__file__), '..', 'data', 'news_providers.txt')
        if not os.path.exists(path):
    ...
    def _load_areas(self) -> list:
        ...
        Raises:
            IOError: If there is an error reading the file.
        """
        path = os.path.join(os.path.dirname(__file__), '..', 'data', 'areas.json')
        if not os.path.exists(path):
